...
from database import get_data_from_db, opening_the_database
    ...
    def property_parsing():
        ...
        try:
            ...
            workbook = load_workbook(
                filename=f"data/initial_data/{number_month}/164.xlsx"
