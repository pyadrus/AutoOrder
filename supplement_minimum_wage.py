...
file_dog = "data/Доплата_до_МРОТ.docx"
data_mounts = "январь"
...
def record_data_salary_downtime_week():
    ...
    doc.render(context)
    doc.save(f"data/Доплата_до_МРОТ_{data_mounts}.docx")
...
def property_parsing():
    ...
    try:
        ...
        workbook = load_workbook(filename='data/130.xlsx')  # Загружаем выбранный файл Excel
